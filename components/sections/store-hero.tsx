...
export function StoreHero() {
  return (
    <section className="store-hero" id="inicio">
      <div className="store-hero-media" data-parallax><Image className="store-hero-image" src="/images/odin-editorial-hero-v1.webp" alt="Odín entre niebla, cuervos y roca en la costa del norte" fill priority sizes="100vw" /></div>
      ...
      <a className="hero-scroll" href="#novedades" aria-label="Desplazarse hasta la colección">
        <span>Descender</span><i />
      </a>
    </section>
  );
}
